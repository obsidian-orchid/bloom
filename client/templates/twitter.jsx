...
twitterAPI = React.createClass({
  ...
  goToTwitter(){
    ...
    Meteor.loginWithTwitter({}, function(err) {
      if (err) {
        throw new Meteor.Error("Twitter login failed, " + err);
      }
      console.log('Twitter_login: ', event);
    });
  },
  ...
  render(){
    return (
      <div>
        ...
        <br></br>
        <a className="btn waves-effect waves-light" onclick={this.goToTwitter()} name="action">ENABLE TWITTER
