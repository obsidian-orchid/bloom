<<<<<<< 5bce3905b693eacb43f55c1348c56e0163a94ded
=======
let js2xmlparser = Meteor.npmRequire( 'js2xmlparser' );
convertJsonToXml = ( root, data ) => {
...
=======
   ...
   deleteImgur: function(url){
    ...
    postGoogle: function(url){
      ...
      //http.get("https://picasaweb.google.com/data/feed/api/user/113073405904591872693/albumid/default", function(err, resp){
      //  console.log(resp);
      //})
      //var xmlData = convertJsonToXml("entry",{
      //  "@": {
